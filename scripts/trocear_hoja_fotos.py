...
HOJAS = {
    "jaecoo-7": r"M AUTOMOCION\ARVAL\JAECOO 7 PHEV BUSINESS\FOTOS COCHE.png",
    "omoda-5": r"M AUTOMOCION\ARVAL\OMODA 5 HEV BUSINESS\FOTO COCHE.png",
    "toyota-hilux": r"M AUTOMOCION\TOYOTA HILUX\FOTOS TOYOTA HILUX.png",
    ...
    "seat-arona": r"MOVENTO\ARVAL\SEAT ARONA\FOTOS COCHE.png",
    ...
    "ebro-s400": r"M AUTOMOCION\AYVENS\EBRO S400\FOTOS EBRO S400.png",
    "honda-crv": r"QUADIS\AYVENS\HONDA CR V\FOTOS HONDA.png",
    "hyundai-tucson": r"M AUTOMOCION\AYVENS\HYUNDAI TUCSON 239CV ECO\FOTOS TUCSON.png",
    "jaecoo-5": r"M AUTOMOCION\ARVAL\JAECCO 5 EXCLUSIVE\FOTOS JAECCO 5.png",
    ...
    "seat-ibiza-115": r"M AUTOMOCION\ARVAL\SEAT IBIZA 115CV\FOTOS SEAT IBIZA.png",
    "seat-ibiza-80": r"M AUTOMOCION\ARVAL\SEAT IBIZA 80CV\FOTOS IBIZA 80CV.png",
    "seat-leon-fr": r"MOVENTO\VOLKWAGUEN FINANCE\SEAT LEON FR\FOTOS DEL SEAT LEON FR",
    "skoda-fabia": r"QUADIS\ARVAL\SKODA FABIA\FOTOS FABIA.png",
    "toyota-chr": r"M AUTOMOCION\ARVAL\TOYOTA CHR\FOTOS TOYOTA CHR.png",
    "toyota-yaris": r"M AUTOMOCION\ARVAL\TOYOTA YARIS\FOTOS TOYOTA YARIS.png",
    ...
    # vw-taigo NO va en este mapa, a proposito. La hoja que habia antes en
    # VOLKSWAGEN FINANCE era un T-Cross con el rotulo TAIGO pegado. La buena
    # esta en M AUTOMOCION/AYVENS/TAIGO y trae once fotos, pero en la fila del
    # medio el lateral, el frontal y la trasera van pegados sin calle blanca,
    # y esta plantilla no sabe separarlos: se cortaron a mano, con las
    # costuras en x=543 y x=913 de una hoja de 1536x1024.
