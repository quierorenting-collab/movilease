      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pb-14 pt-24 sm:px-10">
        ...
        <div className="grid grid-cols-2 gap-12 sm:grid-cols-4 lg:gap-16">
          ...
          <div className="col-span-2 flex flex-col gap-6 sm:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-white/15 text-white/75 transition-all duration-300 hover:border-[#0068FF]/50 hover:text-[#0068FF]"
              >
          ...
          <nav aria-label="Plataforma">
            ...
            <ul role="list" className="flex flex-col gap-0.5 sm:gap-1">
              {[
                ...
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="inline-flex min-h-[44px] items-center text-[14px] text-white/70 transition-colors duration-300 hover:text-white"
                  >
                    {l.label}
                  </Link>
                </li>
