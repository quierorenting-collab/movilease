      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            {/* La visibilidad va en el envoltorio y no en el enlace: .btn-whatsapp
                fija display fuera de capa y la regla que lo oculta en móvil
                (.btn-whatsapp.hidden, globals.css) ganaba también a
                sm:inline-flex, así que el botón no salía a ningún ancho.
                Desde xl se oculta a propósito: ahí está el menú completo, que
                llena el ancho de max-w-7xl, y WhatsApp sigue en el botón
                flotante de todas las páginas. */}
